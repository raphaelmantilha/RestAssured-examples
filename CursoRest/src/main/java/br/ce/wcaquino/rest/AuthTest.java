...
public class AuthTest {
	...
	public void deveObterClima() {
		given()
			...
			.queryParam("appid", "631a57a2a3f2f5cd07db6b0acebade74")
	...
	public void deveAcessarAplicacaoWeb() {
		//login
		 String cookie = given()
			.log().all()
			.formParam("email", "raphael.mantilha@gmail.com")
		...
		//Obter conta
		 String body = given()
			...
			.then()
				.log().all()
				.statusCode(200)
				.body(hasXPath("//td[text()='Conta Raphael']",is("Conta Raphael")))
				//.body("html.body.table.tbody.tr[6].td[0]",is("Conta Raphael"))
				.extract().body().asString()
			;
		 
		 System.out.println("---------");
		 XmlPath xmlPath = new XmlPath(CompatibilityMode.HTML,body);
		 System.out.println(xmlPath.getString("html.body.table.tbody.tr[6].td[0]"));
	}
}
